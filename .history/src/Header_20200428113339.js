        ...
        return(
                <header>
                    <div className="form-container">
                        ...
                        <StyledDropdown textType="Body" onChange={this.props.onBodyChange} value={this.props.bodyValue} />
                    </div>
                    <form className="form-container">
                        <div>
                            <label>Choose a Background Gradient:</label>
                            <StyledDropdown value={this.props.value} onChange={this.props.onGradientChange}>
