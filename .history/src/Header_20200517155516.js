        ...
        return(
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown defaultValue={{value: this.props.headerValue, label: this.props.headerValue}}  onChange={this.props.onHeaderChange} value={options.forEach((option, i)=>
          {
            console.log('logging', option.options.map(i => i.value).indexOf(this.props.headerValue))
            if (option.options.map(i => i.value).indexOf(this.props.headerValue) >= 1){
              index = option.options.map(i => i.value).indexOf(this.props.headerValue);
            }
          })} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
