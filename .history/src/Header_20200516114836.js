    ...
    render(){
        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      <label>Body:</label>
                          <Dropdown textType="" onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                          <span style={{display: 'block', margin: '6px'}}/>
