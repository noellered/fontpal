        ...
        return(
                <header>
                    <div className="form-container">
                        <Dropdown defaultValue="Header Font" textType="Header" onChange={this.props.onHeaderChange} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                        <br/>
                    ...
                    <div className="form-container">
                        <div>
                            ...
                            <Select className="selector" value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                            <br/>
                            <label>Body Font Weight:</label>
                            <Select className="selector" value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                        </div>
                    </div>
                    <div className="form-container">
                      <label>Background Gradient:</label>
                      <Select className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
