        ...
        return(
                <header>
                    <div className="form-container">
                        {/* <Dropdown textType="Header" onChange={thiZZZs.props.onHeaderChange} value={this.props.headerValue}/> */}
                        <Dropdown textType="Body" onChange={this.props.onBodyChange} value={this.props.bodyValue} />
                        <DropdownButton id="dropdown-item-button" textType="Header" onChange={this.props.onHeaderChange} value={this.props.headerValue}>
