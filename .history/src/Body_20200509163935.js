                ...
                <div className={`body-div ${this.state.myGradient}`}> 
                    <div style={{display: 'flex', flexDirection: 'row'}}> 
                        ...
                        <div className="preview-area">
                            ...
                            <div style={{display: 'block', width: '100%', paddingTop: '150px', bottom: '0', fontSize: '.6rem', color: 'white', textTransform: 'uppercase'}}>Brought to you by <a href="https://noellered.com" target="_blank">NoelleRed</a></div>
                        </div>
                    </div>
                </div>
            </div>
