...
const HeaderText = ({fontFamily, fontWeight, headerSize}) => {
    ...
    handleUserInput = (e) => {
        ...
        return(
           <TextareaAutosize value={userInput} onChange={this.handleUserInput} key={this.props.fontFamily} spellcheck="false" className="header-text" style={{fontFamily: this.props.fontFamily, fontWeight: this.props.fontWeight, fontSize: `${this.props.headerSize}rem`}}></TextareaAutosize>
        );
}
