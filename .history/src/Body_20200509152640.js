...
class Body extends Component {
    ...
    render(){
        ...
        return(
            <div> 
                <div className={`body-div ${this.state.myGradient}`} style={{display: 'flex', flexDirection: 'row'}}> 
                    <Header 
                    ...
                    />
                    <div style={{display: 'inline-flex', flexGrow: '1', flexDirection: 'column'}}>
                        <HeaderText style={{display:}} fontFamily={this.state.headerValue} fontWeight={this.state.headerFontWeight} headerSize={this.state.headerSize}/>
