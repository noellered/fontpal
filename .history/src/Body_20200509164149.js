                    ...
                    <div style={{display: 'flex', flexDirection: 'row'}}> 
                        ...
                        <div className="preview-area">
                            ...
                            <div style={{
                                display: 'block', 
                                width: '100%', 
                                paddingTop: '100px', paddingBottom: '50px', bottom: '0', fontSize: '.6rem', color: 'white', textTransform: 'uppercase'}}>Created by <a href="https://noellered.com" target="_blank">NoelleRed</a></div>
                        </div>
                    </div>
                </div>
            </div>
