...
class Header extends React.Component {
    ...
    //Fetches Google Fonts by popularity and sets fonts state to array of all google font family names - limited to 100 by default
      ...
      determineIndex(groupedOptions, choice) {
        var index = 0;
        groupedOptions.forEach((option, i) => {
        ...
        return(
                ...
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown onChange={this.props.onHeaderChange} value={this.options[index]} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
