...
const SpanText = ({fontFamily, fontWeight, lineHeight, bodySize}) => {
    ...
    return(
        <TextareaAutosize 
        spellcheck="false" 
        className="body-text" style={{fontFamily: this.props.fontFamily, fontWeight: this.props.fontWeight, lineHeight: this.props.lineHeight, fontSize: `${this.props.bodySize}rem`}}>{defaultText}</TextareaAutosize>
    );
}
