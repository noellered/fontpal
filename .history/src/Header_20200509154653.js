        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      ...
                      <Select placeholder="Choose a Gradient..." className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles} menuIopen={true}/>
                    </div>
                </header>
        );
    }
