  ...
  componentDidMount(){
    ...
    render(){
        ...
        return(    
            ...
            <form className="textSelectors">
              <label>Choose a {textType} Family:</label>
              <Select value={this.props.value} onChange={this.props.onChange} options=[{label: 'sans-serif fonts', options: [label:] }]/>
                <optgroup label="Sans-Serif Fonts">
                  {this.state.sansSerif.map((family) => key={family} value={family}> {family} </option>)}
                </optgroup>
                <optgroup label="Serif Fonts">
                  {this.state.serif.map((family) => <option key={family} value={family}> {family} </option>)}
                </optgroup>
