...
class Header extends React.Component {
    ...
    render(){
        ...
        return(
                ...
                value={options.find(({value}) => this.state.currentValue === value)}defaultValue={{value: this.props.bodyValue, label: this.props.bodyValue}} onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                          <span style={{display: 'block', margin: '6px'}}/>
