...
class Body extends Component {
    ...
    handleWeightChange = selectedOption => {
        this.setState({headerFontWeight})
    }
    ...
    render(){
        ...
        return(
            <div> 
                <Header onHeaderChange={this.handleHeaderChange} onWeightChange={this.handleWeightChange} headerValue={this.state.headerValue} onBodyChange={this.handleBodyChange} bodyValue={this.state.bodyValue} onGradientChange={this.handleGradientChange}/>
