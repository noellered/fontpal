        ...
        return(
                <header>
                    <div className="form-container">
                        <Dropdown defaultValue={{value: this.props.headerValue, label: this.props.headerValue}}  onChange={(e) => {console.log(e); this.props.onHeaderChange}} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                      <label>Header:</label>
