...
//Fetches Google Fonts API and sets fonts state to array of all google font family names
  ...
  componentDidMount(){
    ...
    render(){
        ...
        let sansSerifFonts = [{value: this.state.sansSerif, label: this.state.sansSerif}]
        return(    
            ...
            <form className="textSelectors">
              <label>Choose a {textType} Family:</label>
              <Select value={this.props.value} onChange={this.props.onChange} options={sansSerifFonts}/>
            //     <optgroup label="Sans-Serif Fonts">
            //       {this.state.sansSerif.map((family) => <options key={family} value={family}> {family} </option>)}
            //     </optgroup>
            //     <optgroup label="Serif Fonts">
            //       {this.state.serif.map((family) => <option key={family} value={family}> {family} </option>)}
            //     </optgroup>
