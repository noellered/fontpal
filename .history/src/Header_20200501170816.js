...
class Header extends React.Component {
    ...
    render(){
        ...
        const groupedOptions = [
          {
            label: 'Sans-Serif',
            options: expanded ? sansSerifFonts : 'none'
          },
          {
            label: 'Serif',
            options: serifFonts
        ...
        return(
                <header>
                    <div className="form-container">
                        <Dropdown textType="Header" onChange={this.props.onHeaderChange} onClick value={this.props.headerLabel} options={groupedOptions} styles={customStyles}/>
                        <Dropdown textType="Body" onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} open={true}/>
                    </div>
