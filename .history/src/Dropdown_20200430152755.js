...
//Fetches Google Fonts API and sets fonts state to array of all google font family names
  ...
  componentDidMount(){
    ...
    render(){
        ...
        const sansSerifFonts = this.state.sansSerif.map(family => ({value: family, label: family, style: {fontFamily: [...sansSerifFonts]}}));
        ...
        return(
            <form className="textSelectors">
              ...
              <Select value={this.props.value} onChange={this.props.onChange} options={groupedOptions} style={{fontFamily: [...sansSerifFonts]}} menuIsOpen={true}/>
            </form>
