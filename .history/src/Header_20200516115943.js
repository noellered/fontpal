        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      ...
                      <Select defaultValue={{value: this.props.gradientValue}} className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
