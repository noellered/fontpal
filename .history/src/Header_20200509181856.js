                ...
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        ...
                        <Select placeholder="Choose a Weight..." key="headerWeight" className="selector" value={this.options[index]} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
