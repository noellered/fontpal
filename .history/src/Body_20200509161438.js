...
class SpanText extends Component {
    render(){
        const defaultText = "This is a font pairing app for Google Web Fonts. The text on this page is editable, so go ahead and try putting in your own. You can chang the font famiy, size, weight, and line height. Don't forget to check out the pre-loaded background gradients for some extra flare!" + <br></br>
        return(
