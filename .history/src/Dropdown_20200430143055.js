...
//Fetches Google Fonts API and sets fonts state to array of all google font family names
  ...
  componentDidMount(){
    ...
    render(){
        ...
        const ssFonts = this.state.sansSerif.map(family => ({fontFamily: family}));
        ...
        return(
            <form className="textSelectors">
              ...
              <Select value={this.props.value} onChange={this.props.onChange} options={groupedOptions} style={ssFonts}/>
            </form>
