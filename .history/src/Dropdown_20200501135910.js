...
//Fetches Google Fonts API and sets fonts state to array of all google font family names - limited to 100 by default
  componentDidMount(){
    fetch('https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyDSHr-iLuL_U335Y437hDvqNFSuv1jAkSI')
      .then(res => {
        ...
        //iterate through fonts array and categorize fonts by type (only use top 100 fonts)
