...
class Header extends React.Component {
      ...
      determineIndex(options, choice) {
        let index = 0;
          ...
          for(let i=0; i < options.length; i++){
            index = options[i].options.findIndex(()=> this.props.headerLabel);
            console.log('index is ', this.props.headerl)
        }
        return index;
      }
    ...
    render(){
        ...
        const index = this.determineIndex(groupedOptions, this.props.headerLabel);
        console.log(index);
