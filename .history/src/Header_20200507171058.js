        ...
        return(
                <header>
                    <div className="form-container">
                        ...
                        <br/>
                        <Dropdown placeholde="" textType="Body" onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                    </div>
                    <div className="form-container">
                        <div>
