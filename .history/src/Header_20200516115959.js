        ...
        return(
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown placeholder="Rubik" onChange={this.props.onHeaderChange} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                        <span style={{display: 'block', margin: '6px'}}/>
                        <Select placeholder="Bold" key="headerWeight" className="selector" value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                    ...
                    <div className="form-container">
                      <label>Body:</label>
                          <Dropdown placeholder="Open Sans" onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                          <span style={{display: 'block', margin: '6px'}}/>
                          <Select placeholder="Regular" key="bodyWeight" className="selector" value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                          <div className="font-slider">
                            <FontAwesomeIcon icon={faFont} size="xs" style={{display: 'inline-block', paddingTop: '8px', color: 'white'}}/>
                            <FontAwesomeIcon icon={faFont} size="lg" style={{display: 'inline-block', paddingLeft: '3px', paddingRight: '10px', color: 'white'}}/>
                            <input style={{display: 'inline-block', width: '80%'}}
                    ...
                    <div className="form-container">
                      ...
                      <Select defaultValue={{value: this.props.gradientValue, label: this.props.gradientValue}} className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
