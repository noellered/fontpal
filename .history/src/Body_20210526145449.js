...
const SpanText = ({fontFamily, fontWeight, lineHeight, bodySize}) => {
    ...
    return(
        ...
        spellcheck="false" 
        className="body-text" 
        style={{fontFamily: this.props.fontFamily, fontWeight: this.props.fontWeight, lineHeight: this.props.lineHeight, fontSize: `${this.props.bodySize}rem`}}>
            {defaultText}</TextareaAutosize>
    );
}
