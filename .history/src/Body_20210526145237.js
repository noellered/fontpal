...
const HeaderText = ({fontFamily, fontWeight, headerSize}) => {
    ...
    const handleUserInput = (e) => {
        ...
        return(
           <TextareaAutosize 
            value={userInput} onChange={handleUserInput} key={fontFamily} spellcheck="false" className="header-text" style={{fontFamily: this.props.fontFamily, fontWeight: this.props.fontWeight, fontSize: `${this.props.headerSize}rem`}}></TextareaAutosize>
        );
}
