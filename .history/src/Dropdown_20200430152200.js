    ...
    render(){
        ...
        const groupedOptions = [
          {
            ...
            style: {fontFamily: this.state.sansSerif}
          },
          {
            label: 'Serif',
            options: serifFonts
        ...
        return(
            <form className="textSelectors">
              ...
              <Select value={this.props.value} onChange={this.props.onChange} options={groupedOptions} style={{fontFamily: this.state.sansSerif}}/>
            </form>
