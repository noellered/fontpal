        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      ...
                      <Select placeholder="Blue" defaultValue={} className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
