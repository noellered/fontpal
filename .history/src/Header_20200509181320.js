        ...
        return(
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown onMenuOpen={this.onMenuOpen} onChange={this.props.onHeaderChange} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
