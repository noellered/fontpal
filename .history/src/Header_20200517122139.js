    ...
    render(){
        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      <label>Body:</label>
                          <Dropdown defaultValue={{value: this.props.bodyValue, label: this.props.bodyValue}} onChange={this.props.onBodyChange} value={groupedOptions[18]} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                          <span style={{display: 'block', margin: '6px'}}/>
