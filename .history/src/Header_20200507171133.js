        ...
        return(
                <header>
                    <div className="form-container">
                        <Dropdown placeholder="Header Family" textType="Header" onChange={this.props.onHeaderChange} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                        <br/>
                        <Dropdown placeholder="Body Family" textType="Body" onChange={this.props.onBodyChange} value={this.props.bodyLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                    </div>
                    <div className="form-container">
                        <div>
                            <label>Header Font Weight:</label>
                            <Select placeholder="Header Weight" className="selector" value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                            <br/>
                            <label>Body Font Weight:</label>
                            <Select placeholder="Body Weight" className="selector" value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                        </div>
                    </div>
                    <div className="form-container">
                      <label>Background Gradient:</label>
                      <Select placeholder="Background Gradient" className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
