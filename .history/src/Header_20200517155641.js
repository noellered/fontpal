        ...
        return(
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown defaultValue={{value: this.props.headerValue, label: this.props.headerValue}}  onChange={this.props.onHeaderChange} value={groupedOptions[0]} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
