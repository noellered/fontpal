...
nst Option = props => {
  return (
      <components.Option {...props} id={myCustomId} />
  );
};
        ...
        return(
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        <Dropdown componentsdefaultValue={{value: this.props.headerValue, label: this.props.headerValue}}  onChange={this.props.onHeaderChange} value={this.props.headerLabel} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
