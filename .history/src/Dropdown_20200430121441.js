...
//Fetches Google Fonts API and sets fonts state to array of all google font family names
  ...
  componentDidMount(){
    ...
    render(){
        ...
        const sansSerifFonts = this.state.sansSerif.map(family => ({value: family, label: family, fontFamily: family}));
        ...
        const monospaceFonts = this.state.monospace.map(family => ({value: family, label: family, fontFamily: family}));
