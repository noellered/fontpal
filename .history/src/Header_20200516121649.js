                ...
                <header>
                    <div className="form-container">
                      <label>Header:</label>
                        ...
                        <Select defaultValue={{value: this.props.fontWeight, label: 'Bold'}} key="headerWeight" className="selector" value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                    ...
                    <div className="form-container">
                      <label>Body:</label>
                          ...
                          <span style={{display: 'block', margin: '6px'}}/>
                          <Select defaultValue={{value: this.props.fontWeight, label: 'Regular'}} key="bodyWeight" className="selector" value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                          <div className="font-slider">
                            <FontAwesomeIcon icon={faFont} size="xs" style={{display: 'inline-block', paddingTop: '8px', color: 'white'}}/>
                            <FontAwesomeIcon icon={faFont} size="lg" style={{display: 'inline-block', paddingLeft: '3px', paddingRight: '10px', color: 'white'}}/>
                            <input style={{display: 'inline-block', width: '80%'}}
