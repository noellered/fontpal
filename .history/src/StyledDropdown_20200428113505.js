...
//Fetches Google Fonts API and sets fonts state to array of all google font family names
  ...
  toggleList(){
    ...
    render(){
        ...
        return( 
            <div className="textSelectors dd-header">
              <div className="dd-headerTitle">Choose a {textType} Family:</div>
              <ul className="dd-list" value={this.props.value} onChange={this.props.onChange}>
                <li className="dd-listItem" label="Sans-Serif Fonts">
                  {this.state.sansSerif.map((family) => <option key={family} value={family}> {family} </option>)}
                </li>
                <li className="dd-listItem" label="Serif Fonts">
                  {this.state.serif.map((family) => <option key={family} value={family}> {family} </option>)}
                </li>
                <li className="dd-listItem" label="Display Fonts">
                  {this.state.display.map((family) => <option key={family} value={family}> {family} </option>)}
                </li>
                <li className="dd-listItem" label="Handwriting Fonts">
                  {this.state.handwriting.map((family) => <option key={family} value={family}> {family} </option>)}
                </li>
                <li className="dd-listItem" label="Monospace Fonts">
...
export default onClickOutside(StyledDropdown);