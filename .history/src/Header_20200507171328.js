                ...
                <header>
                    ...
                    <div className="form-container">
                        <div>
                            ...
                            <Select placeholder="Weight" key="headerWeight" className="selector" value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                            <br/>
                            <label>Body Font Weight:</label>
                            <Select placeholder="Weight" key="bodyWeight" className="selector" value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                        </div>
                    </div>
                    <div className="form-container">
