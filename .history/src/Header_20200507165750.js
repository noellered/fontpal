    ...
    render(){
        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                        <div>
                            <label>Choose a Header Font Weight:</label>
                            <Select value={this.props.value} onChange={this.props.onHeaderWeightChange} options={weights} styles={customStyles}/>
                            <br/>
                            <label>Choose a Body Font Weight:</label>
                            <Select value={this.props.value} onChange={this.props.onBodyWeightChange} options={weights} styles={customStyles} />
                        </div>
                    </div>
                    <div className="form-container">
                      <label>Choose a Background Gradient:</label>
                      <Select value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
