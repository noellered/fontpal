        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      <label>Body:</label>
                          <Dropdown 
                value={this.props.options.find(({value}) => this.props.bodyLabel === value)} defaultValue={{value: this.props.bodyValue, label: this.props.bodyValue}} onChange={this.props.onBodyChange} options={groupedOptions} styles={customStyles} formatGroupLabel={formatGroupLabel}/>
                          <span style={{display: 'block', margin: '6px'}}/>
