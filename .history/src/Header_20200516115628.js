        ...
        return(
                <header>
                    ...
                    <div className="form-container">
                      ...
                      <Select placeholder="Blue" defaultValue={this.props.value} className="selector" value={this.props.value} onChange={this.props.onGradientChange} options={gradients} styles={customStyles}/>
                    </div>
                </header>
        );
    }
