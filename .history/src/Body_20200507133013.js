...
class Body extends Component {
    ...
    render(){
        ...
        return(
            <div> 
                <Header onHeaderChange={this.handleHeaderChange} on headerValue={this.state.headerValue} onBodyChange={this.handleBodyChange} bodyValue={this.state.bodyValue} onGradientChange={this.handleGradientChange}/>
