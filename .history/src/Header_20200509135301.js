                    ...
                    <div className="form-container">
                      <label>Header Style:</label>
                        ...
                        <div className="font-slider">
                          <FontAwesomeIcon icon={faFont} size="xs" style={{display: 'inline-block', paddingTop: '5px', paddingRight: '10px'}}/>
                          ...
                          />
                          <FontAwesomeIcon icon={faFont} size="lg" style={{display: 'inline-block', paddingLeft: '10px'}}/>
                        </div>
                    </div>
                    <div className="form-container">
                      <label>Body Style:</label>
                          ...
                          <div className="font-slider">
                            <FontAwesomeIcon icon={faFont} size="xs" style={{display: 'inline-block', paddingTop: '8.5px'}}/>
                            <FontAwesomeIcon icon={faFont} size="lg" style={{display: 'inline-block', paddingLeft: '3px', paddingRight: '10px'}}/>
                            <input style={{display: 'inline-block', width: '80%'}}
                                type="range"
                                className="slider"
                                min={1}
                        ...
                        <div className="font-slider">
                        <FormatLineSpacingRoundedIcon style={{display: 'inline-block', paddingRight: '10px'}}/>
