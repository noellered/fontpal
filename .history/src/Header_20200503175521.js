...
class Header extends React.Component {
    ...
    render(){
        ...
        const sansSerifFonts = this.state.sansSerif.map(family => ({value: family, label: family, fontname: family, display: this.state.showSSInfo ? 'block' : 'none', icon: this.state.showSSInfo ? faCaretUp : faCaretD}));
